...
def load_data(image_path, input_height, input_width, resize_height=64, resize_width=64, crop=True, is_gray_scale=False, random_flipping = False):
    ...
    if random_flipping == True:
        img_trans = random_flip(img_trans)
